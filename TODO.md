...
- [2026-09-05] `extensions/goal/utils.ts` — Dropped scaffolding-only `GoalObjective` interface (was unreferenced). If a richer objective shape later needs an exported type (e.g., metadata for goal_set tool), reintroduce it then.
